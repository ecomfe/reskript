...
export default async (cwd: string) => {
    ...
    if (isBrokenTestScript(testScript || '')) {
        warn(
            ...
            'see: https://ecomfe.github.io/reskript/docs/migration/v2#test'
        );
    }
    ...
    if (buildScript && /--src[ =]/.test(buildScript)) {
        warn(
            ...
            'see: https://ecomfe.github.io/reskript/docs/migration/v2#build'
        );
    }
    ...
    if (devScript && /--src[ =]/.test(devScript)) {
        warn(
            ...
            'see: https://ecomfe.github.io/reskript/docs/migration/v2#dev'
        );
    }
    ...
    if (babelScript && /--out[ =]/.test(babelScript)) {
        warn(
            ...
            'see: https://ecomfe.github.io/reskript/docs/migration/v2#babel'
        );
    }
};
